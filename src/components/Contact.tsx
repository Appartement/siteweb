    ...
    <div className="bg-white">
      ...
      <div className="relative h-[40vh] overflow-hidden">
        ...
        <div className="relative h-full flex items-center justify-center text-center">
          <div className="max-w-4xl px-4">
            <h1 className="text-5xl font-light text-white mb-6 tracking-wider">Un projet? Une question?</h1>
      ...
      <div className="max-w-7xl mx-auto px-4 py-16">
        <div className="text-center mb-16">
          <h2 className="text-4xl font-light mb-6">Nous sommes là pour vous !</h2>
          <p className="text-gray-600 font-light max-w-3xl mx-auto">
            « Nous travaillons ensemble pour un projet qui vous ressemble, et permettre de vous sentir immédiatement "chez vous". 
            Contactez-nous à tout moment: nous avons à coeur de vous offrir une expérience agréable et mémorable »
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16">
          ...
          <div className="space-y-12">
              ...
              <div>
                ...
                <div className="space-y-3 text-gray-600">
                  <p className="flex items-center">
                    ...
                    <a href="mailto:laure.fargeot@lappartement.pt" className="hover:text-[#81a197] transition-colors">
                  ...
                  <p className="flex items-center">
                    ...
                    <span>
                      FR: <a href="tel:+33662281830" className="hover:text-[#81a197] transition-colors">+33 6 62 28 18 30</a>
                    </span>
                  </p>
                  <p className="flex items-center">
                    <Phone className="h-5 w-5 mr-3 text-[#81a197]" />
                    <span>
                      PT: <a href="tel:+351926322486" className="hover:text-[#81a197] transition-colors">+351 926 322 486</a>
                    </span>
                  </p>
                </div>
              </div>
            ...
            <div className="flex items-start space-x-8">
              ...
              <div>
                <h3 className="text-2xl font-light mb-4">Jean-Emmanuel Salvado</h3>
                <div className="space-y-3 text-gray-600">
                  <p className="flex items-center">
                    <Mail className="h-5 w-5 mr-3 text-[#81a197]" />
                    <a href="mailto:je.salvado@lappartement.pt" className="hover:text-[#81a197] transition-colors">
                  ...
                  <p className="flex items-center">
                    <Phone className="h-5 w-5 mr-3 text-[#81a197]" />
                    <span>
                      FR: <a href="tel:+33645923994" className="hover:text-[#81a197] transition-colors">+33 6 45 92 39 94</a>
                    </span>
                  </p>
                  <p className="flex items-center">
                    <Phone className="h-5 w-5 mr-3 text-[#81a197]" />
                    <span>
                      PT: <a href="tel:+351963567868" className="hover:text-[#81a197] transition-colors">+351 963 567 868</a>
                    </span>
                  </p>
                </div>
              </div>
